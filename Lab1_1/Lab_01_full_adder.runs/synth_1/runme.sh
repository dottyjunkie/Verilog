...
HD_PWD='D:/Verilog/Lab_01_full_adder/Lab_01_full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab01_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab01_decoder.tcl
